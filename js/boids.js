...
function sizeCanvas() {
  ...
  width = canvas.width = canvasPos.width;
  height = canvas.height = canvasPos.height;
  console.log("sizeCanvas: " + width + " " + height);
}

const startBoids = () => {
  // Make sure the canvas always fills the whole window
  //window.addEventListener("resize", sizeCanvas, false);
  new ResizeObserver(sizeCanvas).observe(document.getElementById("boids"));
  sizeCanvas();
